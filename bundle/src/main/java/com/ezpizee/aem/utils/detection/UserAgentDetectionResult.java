...
public class UserAgentDetectionResult {
    ...
    public UserAgentDetectionResult() {
        locale = new java.util.Locale(Language.UNKNOWN.getLabel());
        extensions = new HashSet<Extension>();
        ignoredTokens = "";
        unknownTokens = "";
    }
    public UserAgentDetectionResult(Device _device, Browser _browser, OS _os, java.util.Locale _locale, String _extensions) {
        this(_device,_browser, _os, _locale);
        this.extensions = Extension.deserialize(_extensions);
    }
    public UserAgentDetectionResult(Device _device, Browser _browser, OS _os, java.util.Locale _locale, String _extensions, String ignored, String unknown) {
        this(_device,_browser, _os, _locale, _extensions);
        ignoredTokens = ignored;
        unknownTokens = unknown;
    }
    public UserAgentDetectionResult(Device _device, Browser _browser, OS _os, java.util.Locale _locale, String _extensions, String ignored, String unknown, Bot bot) {
        this(_device,_browser, _os, _locale, _extensions, ignored, unknown);
        this.bot = bot;
    }
    public UserAgentDetectionResult(Device _device, Browser _browser, OS _os, java.util.Locale _locale) {
