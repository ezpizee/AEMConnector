package com.ezpizee.aem.kafka.impl;
...
import com.ezpizee.aem.kafka.consumer.Consumer;
...
@Reference(
    referenceInterface= Consumer.class,
...
public class ConsumerManagerImpl {
    ...
    private ThreadPool kafkaPool;
    private AtomicInteger activeThreads;

    private Set<Consumer> registeredConsumers = new HashSet<>();
